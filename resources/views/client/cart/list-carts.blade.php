            ...
            @foreach (Session::get('cart')->products as $item)
                <tr>
                    ...
                    <td class="cart_description">
                        ...
                        <span><a href="#">Màu: <strong>{{ $item['productInfo']->hasColor->name . ',' }}</strong>
                            </a></span>
                        <span><a href="#">Size: <strong>{{ $item['size'] }}</strong> </a></span>
                    </td>
                    <td class="availability in-stock"><span class="label">In stock</span></td>
                    <td class="price">
                        <span>{{ number_format($item['productInfo']->price) }}Đ</span>
                    </td>
                    <td class="qty"><input min="1" max="10" data-id="{{ $item['productInfo']->id }}"
                            class="input-sm" type="number" value="{{ $item['quantity'] }}"></td>
