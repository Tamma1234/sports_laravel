                ...
                <div class="col-md-3 top-banner hidden-sm">
                    <div class="jtv-banner3">
                        <div class="jtv-banner3-inner">
                            <a href="#"><img src="{{asset('assets/client/images/nike-phantom.jpg')}}" alt="HTML template"></a>
                                        ...
                                        <div class="item-inner">
                                            <div class="product-thumbnail">
                                                ...
                                                <div class="pr-img-area">
                                                    <a title="Product title here" href="{{ route('detail', ['id' => $item->id]) }}">
                                                        <figure> <img class="first-img" src="{{$item->image_url}}" alt="HTML template"> <img class="hover-img" src="{{$item->image_url}}" alt="HTML template"></figure>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item-info">
                                                <div class="info-inner">
                                                    <div class="item-title"> <a title="Product title here" href="{{ route('detail', ['id' => $item->id]) }}">{{$item->title}}}</a> </div>
                                                    <div class="item-content">
                                                      
                                                        <div class="item-price">
                                                            <div class="price-box"> <span class="regular-price"> <span class="price">{{number_format($item->price).'Đ'}}</span> </span>
                                                            </div>
                                                        </div>
