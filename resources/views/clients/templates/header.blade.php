<header class="header-area header-3 header-overlay">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5 col-12">
                    <div class="top-bar-left">
                        <!-- welcome -->
                        <div class="welcome">
                            <p>CHÀO MỪNG BẠN ĐẾN VỚI JR SPORT!</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9 col-md-7 col-12">
                    <div class="top-bar-right pull-right clearfix">
                        <!-- language-menu -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <!-- site-logo -->
                    <div class="site-logo">
                        <a href="index.html"><img src="{{ asset('assets/client/images/logo/logo.png') }}" alt="Nikado"></a>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="current"><a href="index.html">Home <i class="fa fa-angle-down"></i></a>
                                    <ul class="submenu">
                                        ...
                                        <li class="current"><a href="index-3.html">Home Shop 3</a></li>
                            ...
                            <li><a href="#"><i class="fa fa-shopping-bag"></i><sup>3</sup></a>
                                <ul>
                                    <li>
                                        ...
                                        <div class="single-shop-cart-wrapper">
                                            <div class="shop-cart-img">
                                                <a href="#"><img src="{{ asset('assets/client/images/product/1.jpg') }}') }}" alt="Image of Product"></a>
                                            </div>
                                            <div class="shop-cart-info">
                                                <h5><a href="#">sport t-shirt men</a></h5>
                                    ...
                                    <li>
                                        ...
                                        <div class="single-shop-cart-wrapper">
                                            <div class="shop-cart-img">
                                                <a href="#"><img src="{{ asset('assets/client/images/product/2.jpg') }}" alt="Image of Product"></a>
                                            </div>
                                            <div class="shop-cart-info">
                                                <h5><a href="#">sport coat amet</a></h5>
                                    ...
                                    <li>
                                        ...
                                        <div class="single-shop-cart-wrapper">
                                            <div class="shop-cart-img">
                                                <a href="#"><img src="{{ asset('assets/client/images/product/3.jpg') }}" alt="Image of Product"></a>
                                            </div>
                                            <div class="shop-cart-info">
                                                <h5><a href="#">Pellentesque men</a></h5>
