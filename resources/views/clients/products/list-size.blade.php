      ...
      <div class="row">
          <div class="col-xs-12">
              <ul>
                  ...
                  <li class="home"> <a title="Go to Home Page" href="{{route('list.product.hot')}}">Danh sách sản phẩm</a><span>&raquo;</span>
                  </li>
                  <li class="___class_+?5___"> <a title="Go to Home Page" >Size {{$nameSize}}</a></li>
              </ul>
          </div>
      </div>
  </div>
