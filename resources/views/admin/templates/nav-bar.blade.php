<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
        <img src="{{ asset('assets/admin/images/jr-sport.jpg') }}" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('assets/admin/images/neymar-1529598382741789830828.jpg') }}"
       ...
       with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('order.index') }}?is_active=cho-xac-nhan" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Chờ xác nhận</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('order.index') }}?is_active=da-xac-nhan" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Đã xác nhận</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('order.index') }}?is_active=da-hoan-thanh" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Đã hoàn thành</p>
                            </a>
                        </li>
